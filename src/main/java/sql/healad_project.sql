...
CREATE SEQUENCE SEQ_FAQ_ID INCREMENT BY 1 MINVALUE 1 NOCYCLE NOCACHE NOORDER ;
...
CREATE SEQUENCE SEQ_NOTICE_ID INCREMENT BY 1 MINVALUE 0 NOCYCLE NOCACHE NOORDER ;

SELECT LAST_NUMBER FROM USER_SEQUENCES WHERE SEQUENCE_NAME = 'SEQ_NOTICE_ID';
